...
const en = {
  ...
  results: {
    ...
    wellness: {
      ...
      taglines: {
        HERACLES: "Power built in. Recovery built for it.",
        HERMES: "Quick mind. Steadier fuel.",
        HYPNOS: "The gains you can't see, until you sleep.",
        CHRONOS: "Playing the long game, on purpose.",
        ATLAS: "High pressure meets high resilience.",
        APHRODITE: "Glow that starts from within.",
        ATHENA: "Your body's smartest line of defense.",
        APOLLO: "Steady energy. No crash in sight.",
        ZEUS: "Command over every part of the system.",
      } as Record<string, string>,
      descriptors: {
        HERACLES: "Superhuman Strength",
        HERMES: "Speed & Sharp Focus",
        HYPNOS: "God of Sleep",
        CHRONOS: "Master of Time",
        ATLAS: "Carries the Weight of the World",
        APHRODITE: "Beauty & Radiance",
        ATHENA: "Wisdom & Strategic Defense",
        APOLLO: "Sun, Light & Vitality",
        ZEUS: "Rules Every Domain",
      } as Record<string, string>,
    },
    sprout: {
      subtitle: "Sprout Lab",
  ...
  supplement: {
    kicker: "Sprout - Supplement",
    notFoundTitle: "Supplement Not Found | Sprout",
    backToResults: "← Back to results",
    dosage: "Dosage",
    bestTime: "Best time",
    withFoodLabel: "With food",
    withMealFat: "With a meal containing fat",
    withFood: "With food",
    emptyStomach: "Empty stomach ok",
    timeOfDay: { morning: "Morning", afternoon: "Afternoon", evening: "Evening" } as Record<string, string>,
    evidence: { high: "High evidence", moderate: "Moderate evidence", low: "Low evidence" } as Record<string, string>,
    ...
    interactions: "Interactions & Pairings",
    noInteractions: "No significant interactions documented.",
    pair: "Pair",
    space: "Space",
    avoid: "Avoid",
    hoursApart: (n: number) => `(${n}h apart)`,
    dietConsiderations: "Diet Considerations",
    vegetarian: "Vegetarian",
    vegan: "Vegan",
    researchCitations: "Research Citations",
    eduOnly: "Educational purposes only. Not medical advice.",
  },
...
const it: typeof en = {
  ...
  results: {
    ...
    wellness: {
      ...
      sharing: "Generazione…",
      shared: "Salvato ✓",
      dims: { energy: "Energia", recovery: "Recupero", resilience: "Resistenza", focus: "Focus", vitality: "Vitalità", longevity: "Longevità" } as Record<string, string>,
      ...
      taglines: {
        HERACLES: "Potenza di serie. Recupero su misura.",
        HERMES: "Mente rapida. Energia più stabile.",
        HYPNOS: "I risultati che non vedi, finché non dormi.",
        CHRONOS: "Il lungo periodo, per scelta.",
        ATLAS: "Alta pressione, alta resilienza.",
        APHRODITE: "Una luminosità che parte da dentro.",
        ATHENA: "La difesa più intelligente del tuo corpo.",
        APOLLO: "Energia costante. Nessun calo in vista.",
        ZEUS: "Il controllo su ogni parte del sistema.",
      } as Record<string, string>,
      descriptors: {
        HERACLES: "Forza Sovrumana",
        HERMES: "Velocità e Lucidità",
        HYPNOS: "Dio del Sonno",
        CHRONOS: "Signore del Tempo",
        ATLAS: "Porta il Peso del Mondo",
        APHRODITE: "Bellezza e Radiosità",
        ATHENA: "Saggezza e Difesa Strategica",
        APOLLO: "Sole, Luce e Vitalità",
        ZEUS: "Domina Ogni Ambito",
      } as Record<string, string>,
    },
    sprout: {
      subtitle: "Sprout Lab",
  ...
  supplement: {
    kicker: "Sprout - Integratore",
    notFoundTitle: "Integratore non trovato | Sprout",
    backToResults: "← Torna ai risultati",
    dosage: "Dosaggio",
    bestTime: "Momento migliore",
    withFoodLabel: "Con il cibo",
    withMealFat: "Con un pasto contenente grassi",
    withFood: "Con il cibo",
    emptyStomach: "Anche a stomaco vuoto",
    timeOfDay: { morning: "Mattina", afternoon: "Pomeriggio", evening: "Sera" } as Record<string, string>,
    evidence: { high: "Evidenza alta", moderate: "Evidenza moderata", low: "Evidenza bassa" } as Record<string, string>,
    evidenceSummary: "Riassunto delle evidenze",
    benefitProfile: "Profilo dei benefici",
    importantNote: "Nota importante",
    interactions: "Interazioni e abbinamenti",
    noInteractions: "Nessuna interazione significativa documentata.",
    pair: "Abbina",
    space: "Distanzia",
    avoid: "Evita",
    hoursApart: (n: number) => `(a ${n}h di distanza)`,
    dietConsiderations: "Considerazioni sulla dieta",
    vegetarian: "Vegetariano",
    vegan: "Vegano",
    researchCitations: "Citazioni scientifiche",
    eduOnly: "Solo a scopo informativo. Non è un consiglio medico.",
  },
